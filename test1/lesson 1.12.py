...
for turn in range(1, 10):
    ...
    row = int(row)
    # row -= 1  Д.З. как решить проблему неудобного ввода, когда начинаем счет с нуля
    column = input("Введите номер столбца(0,1 или 2): ")
    column = int(column)
    # column -= 1  Д.З. как решить проблему неудобного ввода, когда начинаем счет с нуля
    ...
    # print_area() Д.З. вызов функции заменит for cell in area: print(cell)
